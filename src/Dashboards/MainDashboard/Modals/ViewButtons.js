    ...
    return (
      <div className="viewbuttons">
        <div className="buttons-container">
          <button onClick={this.handleMovieClick} className="view">
            Movies
          </button>
          <button onClick={this.handleTvClick} className="view">
            TV
          </button>
          <button onClick={this.handleRestClick} className="view">
            Restaurants
          </button>
          <button onClick={this.handleBooksClick} className="view">
            Books
          </button>
        </div>
      </div>
