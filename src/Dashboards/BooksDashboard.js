...
export default class BooksDashboard extends React.Component {
  componentDidMount() {
    BooksApiService.getBooks().then((books) => {
    ...
    return (
      <div className="activity-dash-container">
        ...
        <div className="activity-dash">
          ...
          <div className="randomdiv">{this.context.isAddActive && <BookForm history={this.props.history} />}</div>
          <div className="activity-results">{content}</div>
