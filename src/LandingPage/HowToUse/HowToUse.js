  ...
  render() {
    return (
      <div className='howtouse-modal'>
        ...
        <p>What Have I Been Up To?: A full-stack application built to help users 
          keep track of all the activities they've done. From rating movies, tv s
          hows, or books - to logging that amazing oyster bar you went to in NOLA last 
          spring break. You'll never forget what you've done and how you felt about it.</p>
          <div>
          <h2>How to use</h2>
          ...
          <div>
            ...
            <p onClick={this.handleCancel} id='close-button'>close</p>
          </div>
      </div>
    )
  }
